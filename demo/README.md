...
For Hugging Face Docker Spaces, use the repository root as the build context and `demo/Dockerfile` as the Dockerfile. After deployment, replace `TODO_HOSTED_SANDBOX_URL` in `submission_metadata.yaml`.
